...
@Component
public class LineStationOrderConfigDetector extends AbstractDemoDetector {
    @Override public String detectorCode() { return "LINE_STATION_ORDER_CONFIG"; }
    @Override public String detectorName() { return "线路站点排序异常检测"; }
    @Override public String objectTypeName() { return "线路"; }
    @Override public String abnormalCategory() { return "线路配置与执行合规异常"; }
    @Override public String abnormalSubtype() { return "线路站点排序异常"; }
